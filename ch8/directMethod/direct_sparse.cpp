...
//    g2o::OptimizationAlgorithmLevenberg *solver = new g2o::OptimizationAlgorithmLevenberg(solver_ptr); // L-M
    ...
    auto linearSolver = std::make_unique<g2o::LinearSolverDense<DirectBlock::PoseMatrixType>>(); // 线性方程求解器
    auto solver_ptr = std::make_unique<DirectBlock>(std::move(linearSolver));      // 矩阵块求解器
